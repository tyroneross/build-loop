...
`implemented`/`verified` mapping names existing repository-relative files or
real commits; every `verified` mapping references passing test/runtime evidence;
...
Exit 2 routes to Iterate; Review-G cannot pass with stale bindings, unsafe
