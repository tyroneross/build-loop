...
def test_npm_publish_is_risky_in_isolation(empty_workdir: Path) -> None:
    # `npm publish` is irreversible; deployment_policy doesn't mark it as
    # "production" target unless the command name matches a prod deploy pattern.
    # So it falls to priority 2 → RISKY, branch-isolated.
