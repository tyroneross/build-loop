...
If the target matches a known profile (simplify, optimize-build, optimize-tests, optimize-bundle, optimize-perf), use the pre-configured settings from `profiles.md`.
