...
1. Invoke the executable contract above. Load `Skill("build-loop:self-improve")` only when processing returned work orders. **EC-01 read-back:** the runner owns accrued-candidate reading/mining; absent input is a clean no-op.
