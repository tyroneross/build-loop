...
| [public-repository-documentation-boundary.md](public-repository-documentation-boundary.md) | Which documents belong in public vs private repos, and the required archive-before-remove flow into `build-loop-memory` | `fact-checker`, documentation/release reviewers |
