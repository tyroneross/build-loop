...
Source of truth: the "Joining a team" section of easy-terminal's `AGENTS.md` (github.com/tyroneross/easy-terminal) (contract evidence: `docs/verification/team-muse-coordination-2026-09-20.md` in easy-terminal). Summary only; follow the source on conflict.
