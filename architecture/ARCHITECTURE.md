...
- `overfitting-reviewer` — opus · _updated 2026-07-22 by Tyrone Ross_ — Reviews optimization results for overfitting, Goodhart violations, and test-gaming shortcuts. Read-only adversarial review.
...
- `scripts/assumption_register.py`
- `scripts/atomic_io.py`
- `scripts/attestation_lint.py`
- `scripts/attribution_audit.py`
...
- `scripts/background_item_identity.py`
- `scripts/backlog.py`
...
- `scripts/consent_ask.py`
- `scripts/consent_conformance.py`
...
- `scripts/file_to_operations_center.py`
- `scripts/frontier_gate.py`
...
- `scripts/hooks/pre_bash_privileged.py`
- `scripts/hooks/run_registration_gate.py`
- `scripts/hooks/session_end_retro_sweep.py`
- `scripts/hooks/unbounded_load_gate.py`
- `scripts/hooks/unbounded_wait_gate.py`
- `scripts/host_capabilities.py`
- `scripts/host_model_map.py`
...
- `scripts/memory_effect.py`
- `scripts/memory_facade/__init__.py`
- `scripts/memory_facade/backlog.py`
...
- `scripts/memory_locator.py`
- `scripts/memory_rank.py`
- `scripts/memory_rank_eval.py`
- `scripts/memory_receipt_report.py`
- `scripts/memory_reconcile.py`
- `scripts/memory_staleness_check.py`
- `scripts/memory_store_stats.py`
- `scripts/memory_telemetry.py`
- `scripts/memory_update_ledger.py`
- `scripts/memory_usability_eval.py`
...
- `scripts/outcome_reconcile.py`
- `scripts/owed_verification.py`
...
- `scripts/prepush_version_gate.py`
- `scripts/prior_art.py`
- `scripts/privacy.py`
- `scripts/privileged_audit.py`
- `scripts/privileged_broker.py`
...
- `scripts/rally_point/actor_identity.py`
- `scripts/rally_point/agent_autoreg.py`
- `scripts/rally_point/backend_adapter.py`
...
- `scripts/rally_point/conftest.py`
...
- `scripts/rally_point/kind_capability.py`
...
- `scripts/rally_point/payload_codec.py`
...
- `scripts/rally_point/retraction.py`
...
- `scripts/reference_pointer_lint.py`
...
- `scripts/retrospective/file_findings.py`
...
- `scripts/share_presentation_check.py`
...
- `scripts/system_access_request.py`
...
- `scripts/transcript_pattern_miner/disposition.py`
- `scripts/transcript_pattern_miner/io_cache.py`
- `scripts/transcript_pattern_miner/memory_route.py`
