---
id: fixture-risk-reason-bogus
dimension: test
severity: low
label: "Fixture: bogus risk_reason value"
...
# Plan: Fixture — bogus risk_reason
...
Item 16 — Risk reason: foo bar (intentionally invalid — should fail risk-reason-invalid-value)
-->

## Goal

Test fixture verifying that `risk_reason: foo bar` (a non-canonical value) causes plan_verify to emit a BLOCKER for rule `risk-reason-invalid-value`.
